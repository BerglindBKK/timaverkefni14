...
const Home = () => {
	...
	//fetches the values from Add expense button and adds to the Expenses array
	...
	//fetches the expenses from the endpoint
	...
	return (
		<div className="w-full max-w-sm mx-auto p-8">
			...
			<div className="w-full max-w-md mx-auto">
				<p className="text-black font-bold text-lg mb-4 pt-8">Your Expenses</p>
